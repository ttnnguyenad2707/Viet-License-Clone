        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="relative h-64 w-full overflow-hidden rounded-2xl border border-border bg-white">
              <Image src="https://res.cloudinary.com/dj4xx7efi/image/upload/v1783236750/microsoft-marketplace-partner-800_e3r1om.jpg" alt="Hồ sơ OLIU GROUP COMPANY LIMITED trên Microsoft Marketplace" fill className="object-cover" />
            </div>
            <div className="relative h-64 w-full overflow-hidden rounded-2xl border border-border bg-white">
              <Image src="https://res.cloudinary.com/dj4xx7efi/image/upload/v1783236751/vat-invoice-sample-800_vowfg8.jpg" alt="Mẫu hóa đơn VAT đã che thông tin nhạy cảm" fill className="object-cover" />
            ...
            <div className="relative h-16 w-full overflow-hidden rounded-2xl border border-border bg-white md:col-span-2">
              <Image src={config.logo.src} alt={config.logo.alt} width={config.logo.width} height={config.logo.height} className="absolute left-4 top-1/2 -translate-y-1/2" />
            </div>
          </div>
        </div>
      </div>
